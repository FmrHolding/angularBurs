...
export class OgrenciEkonomikComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  constructor(
    ...
    this.frmEkonomik = this.fb.group({
      ...
      babameslek: ['', [Validators.required,Validators.pattern('^[a-zA-ZğüşöçİĞÜŞÖÇ \-\']+')]],
      babamaas: ['', [Validators.required]],
      annesag: ['', [Validators.required]],
      anneogrenimid: ['', [Validators.required]],
      annetelefon: ['', [Validators.required]],
      annemeslek: ['', [Validators.required,Validators.pattern('^[a-zA-ZğüşöçİĞÜŞÖÇ \-\']+')]],
      annemaas: ['', [Validators.required]],
      digergelir: [, [Validators.required]],
      geliraciklama: ['', [Validators.required,Validators.pattern('^[a-zA-ZğüşöçİĞÜŞÖÇ \-\']+')]],
      ailesaglik: ['', [Validators.required,Validators.pattern('^[a-zA-ZğüşöçİĞÜŞÖÇ \-\']+')]],
